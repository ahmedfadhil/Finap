...
def home
  ...
  def index
    ...
    @posts= @posts.where(neighborhood: params["neighborhood"]) if params["pneighborhoodrice"].present?
    @posts= @posts.where(zipcode: params["zipcode"]) if params["zipcode"].present?
  end
